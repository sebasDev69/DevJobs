<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            <h3 class="font-extrabold text-4xl text-gray-800 mb-6">Nuestras vacantes disponibles</h3>
                    ...
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            ...
                            <p class="font-bold text-xs text-gray-600">
                                último dia para postularse: <span class="font-normal">{{$vacante->ultimo_dia->format('d/m/Y')}}</span>
                            </p>
                        </div>
                        <div class="mt-2 md:mt-0 displ">
                            <a class="bg-green-400 p-3 text-sm uppercase font-bold text-white rounded-lg block text-center" href="{{route('vacantes.show', $vacante->id)}}"> Ver vacante</a>
                        </div>
                    </div>
                @empty
